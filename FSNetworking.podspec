...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of FSNetworking
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Donald Burr" => "dburr@borg-cube.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Donald Burr', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/dburr/FSNetworking.git", :tag => "0.1" }
